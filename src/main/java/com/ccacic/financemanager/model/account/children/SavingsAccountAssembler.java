...
public class SavingsAccountAssembler extends AccountAssembler<SavingsAccount> {
	...
	protected static final String defDisplayName = "Savings Account";
	 ...
	 */
	public SavingsAccountAssembler(String displayName, String entryType, Set<Currency> currencies,
			Set<Tag> tags) {
